"""
Test suite for accounts models validation - Fixed version.
...
class SubjectModelTests(TestCase):
    ...
    def test_subject_creation_with_name_and_slug(self):
        """
        Validates: DV-003 - Subject model name field MUST be unique and have verbose_name 'Materia'
        """
